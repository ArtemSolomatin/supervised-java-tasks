...
<page:template>
    <jsp:body>
        <c:url value="/addAssessment/assessmentId/newAssessmentId/studentId/newStudentId/subjectId/newSubjectId/semesterNum/newSemesterNum/mark/newMark/examinerSurname/newExaminerSurname" var="addStudent" />
        <!-- Content Column -->
        <div class="col-md-9">
